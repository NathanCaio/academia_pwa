...
const ProductSort = props => {
    ...
    const sortElements = useMemo(() => {
        ...
        const itemElements = Array.from(allSortingMethods, sortItemOriginal => {
            const sortItem = {
                ...sortItemOriginal,
                text: sortsMap[sortItemOriginal.text]
            };
    ...
    return (
        ...
        >
            ...
            >
                <span className={classes.mobileText}>Ordenar</span>
                <span className={classes.desktopText}>
                    <span className={classes.sortText}>
                        Ordenar por {sortsMap[currentSort.sortText]}
                    </span>
                    <Icon
                        src={ArrowDown}
                        classes={{
